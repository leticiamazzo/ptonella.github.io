...
var player;
$("#video-thumb-thaylan").click(function(){
if($("#player-thaylan").is("div")) {
  $(this).hide();
  player = new YT.Player('player-thaylan', {
    height: '550',
    width: '100%',
  ...
  function onPlayerStateChange(event) {
    if(event.data === 0) {
      $("#player-thaylan").remove();
      $("#playerContainerThaylan").append('<div id ="player-thaylan" width="100%" align="left" height="550""></div>');
      $("#video-thumb-thaylan").show();
    }
  }
});
